...
@Autonomous(name="AutoChadTest", group="chad")
public class AutoChadTest extends LinearOpMode {
    //
    DcMotor frontleft;
    DcMotor frontright;
    DcMotor backleft;
    ...
    public void runOpMode(){
        ...
        //
        strafeToPosition(46.0, 0.2);
        //
        moveToPosition(-3.5, 0.2);
        //
        turnWithGyro(45, 0.2);
        //
        moveToPosition(-24, 0.2);
        //
        strafeToPosition(-5.2, 0.2);
        //
        turnWithGyro(45, -0.2);
        //
    }
