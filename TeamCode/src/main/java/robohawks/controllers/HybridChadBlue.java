...
@Autonomous(name="HybridChadBlue", group="ChadTest")
public class HybridChadBlue extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        //double initangle = -angles.firstAngle;//make this negative
        ...
        sleep(500);
        //angles = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
        //double secondangle = angles.first
        //[CHANGES]Move to 2nd brick
        moveToPosition(-68 - brickshift,0.3);
        //
        //Strafe towards blocks
